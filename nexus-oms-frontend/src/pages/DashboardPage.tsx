...
function generateMockRevenueTrend() { const days = ["Mon","Tue","Wed","Thu","Fri","Sat","Sun"]; return days.map(d=>({date:d,revenue:Math.floor(Math.random()*40000)+80000,orders:Math.floor(Math.random()*200)+180})); }

function generateMockTopProducts() { return [{ name: "Product A", sku: "SKU-A", sold: 342, revenue: 68400 }]; }
...
export default function DashboardPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setInventoryHealth({ healthy: 342, low: 28, critical: 7, outOfStock: 3 });
    setSlaMetrics({ onTime: 942, late: 38, breached: 12, avgFulfillmentTime: "3.8h" });
