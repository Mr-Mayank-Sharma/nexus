...
export function getModulesForRole(role: string): WorkspaceModule[] {
  ...
  const roleModules: Record<string, string[]> = {
    ...
    CEO: ['dashboard', 'analytics', 'ai', 'ai-briefing', 'ai-routing', 'ai-packing', 'ai-loading', 'ai-audit', 'ai-forecasting', 'notifications', 'audit', 'documents', 'settings', 'promotions', 'endless-aisle'],
    OPS_MANAGER: ['dashboard', 'orders', 'customers', 'products', 'inventory', 'fulfillment', 'returns', 'picking', 'packing', 'shipping', 'warehouse', 'routing', 'task-queues', 'ai-briefing', 'ai-routing', 'ai-audit', 'ai-forecasting', 'notifications', 'analytics', 'slotting-optimization', 'yard-dock', 'automation-systems', 'promotions', 'endless-aisle'],
    WAREHOUSE_MANAGER: ['dashboard', 'warehouse-dashboard', 'warehouse', 'inventory', 'fulfillment', 'picking', 'packing', 'shipping', 'receiving', 'cycle-counts', 'task-queues', 'analytics', 'notifications', 'wave-planning', 'labor-management', 'slotting-optimization', 'yard-dock', 'automation-systems', 'endless-aisle'],
    PICKER: ['picking', 'inventory'],
    PACKER: ['packer', 'packing', 'inventory'],
    LOADER: ['loader', 'shipping'],
    STORE_MANAGER: ['dashboard', 'store-dashboard', 'orders', 'inventory', 'customers', 'products', 'bopis', 'returns', 'notifications', 'promotions', 'endless-aisle'],
    BOPIS_OWNER: ['bopis', 'bopis-owner', 'orders', 'inventory', 'customers', 'notifications', 'endless-aisle'],
    CUSTOMER_SUPPORT: ['dashboard', 'orders', 'customers', 'returns', 'products', 'notifications', 'promotions'],
