...
SELECT * FROM (VALUES
    ('00000000-0000-0000-0000-00000000a101'::uuid, 'f226ca95-8668-4118-86f1-8e1da072d5da', 'SM-MAILER', 11, 3, 8, 264, 5, 3, TRUE, NOW(), NOW()),
    ('00000000-0000-0000-0000-00000000a102'::uuid, 'f226ca95-8668-4118-86f1-8e1da072d5da', 'SM-BOX', 12, 6, 9, 648, 15, 6, TRUE, NOW(), NOW()),
    ('00000000-0000-0000-0000-00000000a103'::uuid, 'f226ca95-8668-4118-86f1-8e1da072d5da', 'MD-BOX', 16, 8, 12, 1536, 30, 12, TRUE, NOW(), NOW()),
    ('00000000-0000-0000-0000-00000000a104'::uuid, 'f226ca95-8668-4118-86f1-8e1da072d5da', 'LG-BOX', 20, 10, 16, 3200, 50, 20, TRUE, NOW(), NOW()),
    ('00000000-0000-0000-0000-00000000a105'::uuid, 'f226ca95-8668-4118-86f1-8e1da072d5da', 'XL-BOX', 24, 14, 20, 6720, 80, 40, TRUE, NOW(), NOW())
